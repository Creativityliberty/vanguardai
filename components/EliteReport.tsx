...
import { ShieldCheck, Printer, ChevronRight, FileDown, Globe } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-[#f8f9fa] z-[9999] flex flex-col overflow-hidden animate-in fade-in duration-500">
      <header className="bg-black text-white px-8 py-4 flex items-center justify-between shrink-0 z-[100] shadow-2xl print:hidden">
        ...
        <div className="flex items-center space-x-4">
          <button onClick={exportAsHtml} className="bg-white/10 hover:bg-white/20 text-white px-5 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest flex items-center border border-white/10 transition-all">
            <FileDown className="w-4 h-4 mr-2" /> EXPORT HTML
          </button>
          <button onClick={() => window.print()} className="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest flex items-center shadow-lg transition-all">
            <Printer className="w-4 h-4 mr-2" /> IMPRIMER PDF
          </button>
        </div>
      </header>

      <div className="flex-1 overflow-y-auto scroll-smooth py-12 px-4 bg-[#f0f2f5] print:p-0 print:bg-white print:overflow-visible">
        <div id="elite-dossier-content" className="max-w-[850px] mx-auto bg-white shadow-[0_50px_100px_rgba(0,0,0,0.12)] relative border-l-[25px] border-black p-16 md:p-28 print:shadow-none print:p-12 print:m-0 print:border-l-[15px] print:w-full">
          
          <div className="border-b-[6px] border-black pb-16 mb-24 flex justify-between items-end">
            <div className="space-y-8">
              <div className="text-[12px] font-black uppercase tracking-[0.6em] text-gray-400">Vanguard Media // Strategic Dpt.</div>
              <h1 className="text-8xl font-black uppercase tracking-tighter leading-[0.8] m-0 font-serif">Audit <br/>Stratégique <br/>Elite</h1>
          ...
          <div className="bg-gray-50 p-12 border-l-[12px] border-black mb-32 italic font-medium text-xl leading-relaxed text-gray-800 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
               <div className="space-y-10">
                  <div>
                    ...
                    <p className="text-3xl font-black leading-tight text-black">"{biz.promesse}"</p>
                  </div>
                  <div>
               ...
               <div className="bg-black text-white p-10 rounded-2xl flex flex-col justify-center shadow-xl">
          ...
          <section className="mb-32">
            ...
            <div className="space-y-16">
               <div className="bg-gray-100 p-12 rounded-[2rem] border-2 border-gray-200">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  <div className="p-8 border-2 border-red-100 rounded-3xl bg-red-50/40">
                  ...
                  <div className="p-8 border-2 border-purple-100 rounded-3xl bg-purple-50/40">
                  ...
                  <div className="p-8 border-2 border-emerald-100 rounded-3xl bg-emerald-50/40">
          ...
          <section className="mb-32">
            ...
            <div className="space-y-6">
               {personas.map((p: any, i: number) => (
                 <div key={i} className="flex border-3 border-gray-100 rounded-2xl overflow-hidden group hover:border-black transition-all">
                    <div className="bg-gray-50 p-8 w-1/3 border-r-3 border-gray-100 font-black uppercase text-base flex items-center justify-center text-center">{p.nom}</div>
                    <div className="p-8 flex-1 text-base italic text-gray-700 leading-relaxed bg-white">"{p.angle_publicitaire}"</div>
                 </div>
               ))}
            </div>
          </section>
          ...
          <section className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {clusters.map((c: any, i: number) => (
                 <div key={i} className="bg-gray-50 p-10 rounded-3xl border-3 border-gray-100 flex flex-col h-full">
                    ...
                    <div className="space-y-3 mb-8 flex-1">
                      {c.interests.map((int: string, j: number) => (
                        <div key={j} className="text-[11px] font-mono font-black text-gray-600 uppercase flex items-center">
                          <span className="w-2 h-2 bg-black rounded-full mr-4 shrink-0" /> {int}
                        </div>
                      ))}
                    </div>
                    <p className="text-[11px] text-gray-400 italic leading-tight border-t border-gray-200 pt-4">"{c.rationale}"</p>
                 </div>
               ))}
            </div>
          </section>
          ...
          <section className="mb-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
               {ads.map((ad: any, i: number) => (
                 <div key={i} className="border-3 border-gray-100 rounded-3xl overflow-hidden bg-white shadow-sm flex flex-col">
                    ...
                    {ad.image_url && (
                      <div className="aspect-[4/5] w-full">
                         <img src={ad.image_url} alt="Ad Visual" className="w-full h-full object-cover" />
                      </div>
                    )}
                    <div className="p-4 bg-gray-50 flex justify-between items-center border-t border-gray-100">
                       <span className="text-[10px] font-black uppercase tracking-widest">{ad.cta}</span>
                       <span className="text-[8px] text-gray-400 font-mono">SEGMENT: {ad.persona}</span>
                    </div>
                 </div>
               ))}
            </div>
          ...
          <section className="mb-32 page-break-before">
          ...
          <div className="mt-48 pt-24 border-t-[8px] border-black flex flex-col items-center space-y-6 text-center">
             <div className="text-3xl font-black uppercase tracking-[0.6em] text-black">VANGUARD MEDIA</div>
             <p className="text-[12px] font-black text-gray-400 uppercase tracking-[0.5em]">INTELLIGENCE PUBLICITAIRE // RÉSULTATS D'ÉLITE <br/> PROTOCOLE V7.1 FINALISÉ</p>
          </div>
        </div>
      ...
      <style>{`
        @media print {
          ...
          #elite-dossier-content { box-shadow: none !important; margin: 0 !important; width: 100% !important; border-left-width: 10px !important; }
